...
function addRibbon() {
    	...
    	if(ribbonDateRange.contains(ribbonNow)) {
            ...
            const formattedDate = `${month}${day}${year}`; //Output example: 052424
	   		...
	   		htm += '<style>';
	    	htm += '.pledgeBanner{ background:url("'+pledgeImgs+'swyl_bkg_corpBlue.jpg") repeat-x transparent 0 0; height:90px; }';
			...
			htm += '.pledgeBanner .mdAmounts a{ width:216px; height:90px; background:url("'+pledgeImgs+'btn_donateNow_Off.png") no-repeat transparent 0 0; display:inline-block; text-indent:-9000px; }';
			htm += '.pledgeBanner .mdAmounts a:hover{ background:url("'+pledgeImgs+'btn_donateNow_On.png") no-repeat transparent 0 0; }';
			htm += '@media(max-width: 853px) {.pledgeBanner .smAmounts a{ width:103px; height:90px; background:url("'+pledgeImgs+'btn_donateNow_sq_Off.png") no-repeat transparent 0 0; display:inline-block; text-indent:-9000px; }}';
			htm += '.pledgeBanner .smAmounts a:hover{ background:url("'+pledgeImgs+'btn_donateNow_sq_On.png") no-repeat transparent 0 0; }';
			...
			htm += 			'<img class="bannerLogo d-none d-md-block" src="'+pledgeImgs+'swylHeart_l.png" alt="" />';
			htm += 			'<img class="bannerLogo d-md-none" src="'+pledgeImgs+'swylHeart_s.png" alt="" />';
